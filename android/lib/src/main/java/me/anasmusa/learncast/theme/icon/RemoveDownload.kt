...
val RemoveDownload: ImageVector
    get() {
        if (_RemoveDownload != null) {
            return _RemoveDownload!!
        }
        _RemoveDownload = ImageVector.Builder(
            name = "RemoveDownload",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private var _RemoveDownload: ImageVector? = null
