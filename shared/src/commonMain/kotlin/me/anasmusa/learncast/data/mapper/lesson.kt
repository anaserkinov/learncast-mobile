...
internal fun LessonResponse.toEntity() = LessonEntity(
    ...
    audioDuration = audio.duration
        ...
        .inWholeSeconds.toDuration(DurationUnit.SECONDS),
    createdAt = createdAt.toDateTime()
)

internal fun LessonResponse.toInput() = LessonStateInput(
    lessonId = id,
...
internal fun LessonProgressResponse.toInput() = LessonProgressInput(
    lessonId = lessonId,
...
internal fun LessonWithState.toUI() = Lesson(
    id = lesson.id,
    title = lesson.title,
...
fun Lesson.toQueueItem() = QueueItem(
    id = 0,
    referenceId = id,
    referenceUuid = "",
