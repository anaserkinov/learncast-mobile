package me.anasmusa.learncast.data.google_auth
...
internal actual suspend fun googleSignIn(): String? {
    ...
    return try {
        ...
        try {
            ...
            val request = GetCredentialRequest.Builder()
                ...
                .build()
            val result = CredentialManager.create(ApplicationLoader.context)
                .getCredential(
                    context = ApplicationLoader.currentActivity!!,
                    request = request
                )
